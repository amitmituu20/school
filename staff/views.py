...
from classes.models import Subjects,Courses,SessionYearModel
from staff.models import LeaveReportStaff, Staffs,NotificationStaffs,assignment
from student.models import Students,Attendance, AttendanceReport
...
def assignment_add(request):
      ...
      return render(request,"staff_template/assignment_add.html",{"course_name":course_name})

def add_assignment_save(request):
    if request.method!="POST":
         course=request.POST.get("course")
         assign_name=request.POST.get("Assign_name")
         assign_text=request.POST.get("assign_text")
         assign_upload=request.FILES['file']
         ass=assignment(course_id=course,assign_name=assign_name,assign_text=assign_text,assign_upload=assign_upload)
         ass.save()
    messages.success(request, "Successfully published assignment")
    return render(request,"staff_template/assignment_add.html")
