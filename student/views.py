...
from student.models import   LeaveReportStudent, NotificationStudent,Students,Attendance, AttendanceReport,result
...
def student_view_result(request):
    student=Students.objects.get(admin=request.user.id)
    studentresult=result.objects.filter(student_id=student.id)
